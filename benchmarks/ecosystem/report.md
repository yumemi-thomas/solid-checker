...
- Started: 2026-09-03T19:52:43.333Z
- Finished: 2026-09-03T19:54:44.172Z
- Duration: 120839 ms
...
- Durable catalog writes: off (scratch catalogs, no fsync)
- Install lockfile cache: /Users/thomas/Documents/Github/solid-checker/rust/target/install-locks
...
- Verified: 357/397 attempted -- 306 complete, 51 partial (31 with the root); 471 certified entrypoints
...
- Verified (receipt issued): 90 -- 88 complete, 2 partial (0 of those with the root)
- Certified entrypoints (measured): 91
- Exact certification refusals: 4
...
| @solid-primitives/gestures | 1.2.1 | only | success | success | refused |
...
| @solid-primitives/keyed | 1.5.3 | only | success | success | refused |
...
- Verified (receipt issued): 29 -- 5 complete, 24 partial (17 of those with the root)
- Certified entrypoints (measured): 47
- Exact certification refusals: 6
- Proposal lanes: 1 generated-proposal, 8 published-graph, 26 reused-proposal
...
| @tanstack/solid-query | 5.102.5 | only | failure | dependency-contract-obligation | refused |
...
- **@tanstack/solid-form@2.0.0-alpha.2** (only, dependency-contract-obligation): solid-checker: no certifiable artifact case; 1 case(s) refused and 1 case(s) recorded inapplicable; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/form-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/form-core" from <package-root>/dist/index.js; acquire a verified dependency contract and pass its receipt-issued exact i... _(stderr truncated for readability)_
- **@tanstack/solid-hotkeys@0.10.0** (only, dependency-contract-obligation): solid-checker: no certifiable artifact case; 1 case(s) refused and 1 case(s) recorded inapplicable; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/hotkeys solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/hotkeys" from <package-root>/dist/index.js; acquire a verified dependency contract and pass its receipt-issued exact impor... _(stderr truncated for readability)_
- **@tanstack/solid-query@5.102.5** (only, dependency-contract-obligation): solid-checker: no certifiable artifact case; 3 case(s) refused; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/query-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/query-core" from <package-root>/build/index.js; acquire a verified dependency contract and pass its receipt-issued exact import through --accepted-contract... _(stderr truncated for readability)_
- **@tanstack/solid-query-persist-client@5.102.5** (only, dependency-contract-obligation): solid-checker: no certifiable artifact case; 3 case(s) refused; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/query-persist-client-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/query-persist-client-core" from <package-root>/build/index.js; acquire a verified dependency contract and pass its receipt-issued exact impo... _(stderr truncated for readability)_
- **@tanstack/solid-start-server@1.167.36** (only, dependency-contract-obligation): solid-checker: no certifiable artifact case; 1 case(s) refused and 1 case(s) recorded inapplicable; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/start-server-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/start-server-core" from <package-root>/dist/esm/index.js; acquire a verified dependency contract and pass its re... _(stderr truncated for readability)_
...
- **@tanstack/solid-virtual@3.13.37** (only, dependency-contract-obligation): solid-checker: no certifiable artifact case; 1 case(s) refused and 1 case(s) recorded inapplicable; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/virtual-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/virtual-core" from <package-root>/dist/esm/index.js; acquire a verified dependency contract and pass its receipt-issu... _(stderr truncated for readability)_
...
- **@solid-devtools/ext-adapter@0.17.0** (only, no-exported-surface): solid-checker: no certifiable artifact case; 1 case(s) refused; first refusal: .: solid-checker-rust: emit package contract: entry file <package-root>/dist/index.js has no runtime ESM exports
...
- Failures: 1
- Certification attempted: 1
- Verified (receipt issued): 0 -- 0 complete, 0 partial (0 of those with the root)
- Certified entrypoints (measured): 0
- Exact certification refusals: 1
- Proposal lanes: 1 published-graph

| Package | Version | Probe | Outcome | Class | Verified |
| --- | --- | --- | --- | --- | --- |
| motion-solidjs | 0.6.0 | only | failure | dependency-contract-obligation | refused |
...
- Verified (receipt issued): 8 -- 5 complete, 3 partial (2 of those with the root)
- Certified entrypoints (measured): 10
- Exact certification refusals: 4
...
| @solidjs/signals | 2.0.0-rc.3 | only | success | success | refused |
...
- Verified (receipt issued): 1 -- 0 complete, 1 partial (1 of those with the root)
- Certified entrypoints (measured): 7
- Exact certification refusals: 1
- Proposal lanes: 2 reused-proposal

| Package | Version | Probe | Outcome | Class | Verified |
| --- | --- | --- | --- | --- | --- |
| @kobalte/core | 2.0.0-alpha.0 | only | partial-success | partial-success | refused |
...
- Verified (receipt issued): 174 -- 172 complete, 2 partial (0 of those with the root)
- Certified entrypoints (measured): 184
- Exact certification refusals: 14
...
| @solid-primitives/i18n | 3.0.0-next.4 | floor | success | success | refused |
| @solid-primitives/i18n | 3.0.0-next.4 | head | success | success | refused |
...
| @solid-primitives/input-mask | 1.0.0-next.2 | floor | success | success | refused |
| @solid-primitives/input-mask | 1.0.0-next.2 | head | success | success | refused |
...
| @solid-primitives/intersection-observer | 3.0.0-next.3 | floor | failure | dependency-contract-obligation | complete 1 of 1 (root) |
| @solid-primitives/intersection-observer | 3.0.0-next.3 | head | failure | dependency-contract-obligation | complete 1 of 1 (root) |
...
| @solid-primitives/keyed | 3.0.0-next.2 | floor | success | success | refused |
| @solid-primitives/keyed | 3.0.0-next.2 | head | success | success | refused |
...
| @solid-primitives/utils | 7.0.0-next.4 | floor | success | success | refused |
| @solid-primitives/utils | 7.0.0-next.4 | head | success | success | refused |
...
- Verified (receipt issued): 12 -- 2 complete, 10 partial (6 of those with the root)
- Certified entrypoints (measured): 20
- Exact certification refusals: 6
- Proposal lanes: 6 generated-proposal, 12 reused-proposal

| Package | Version | Probe | Outcome | Class | Verified |
| --- | --- | --- | --- | --- | --- |
| @tanstack/solid-query | 6.0.0-rc.0 | floor | failure | dependency-contract-obligation | refused |
| @tanstack/solid-query | 6.0.0-rc.0 | head | failure | dependency-contract-obligation | refused |
...
| @tanstack/solid-query-persist-client | 6.0.0-rc.0 | floor | failure | dependency-contract-obligation | refused |
| @tanstack/solid-query-persist-client | 6.0.0-rc.0 | head | failure | dependency-contract-obligation | refused |
...
Failure details:
- **@tanstack/solid-query@6.0.0-rc.0** (floor, dependency-contract-obligation): solid-checker: no certifiable artifact case; 3 case(s) refused; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/query-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/query-core" from <package-root>/build/index.js; acquire a verified dependency contract and pass its receipt-issued exact import through --accepted-contract... _(stderr truncated for readability)_
- **@tanstack/solid-query@6.0.0-rc.0** (head, dependency-contract-obligation): solid-checker: no certifiable artifact case; 3 case(s) refused; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/query-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/query-core" from <package-root>/build/index.js; acquire a verified dependency contract and pass its receipt-issued exact import through --accepted-contract... _(stderr truncated for readability)_
- **@tanstack/solid-query-persist-client@6.0.0-rc.0** (floor, dependency-contract-obligation): solid-checker: no certifiable artifact case; 3 case(s) refused; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/query-persist-client-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/query-persist-client-core" from <package-root>/build/index.js; acquire a verified dependency contract and pass its receipt-issued exact impo... _(stderr truncated for readability)_
- **@tanstack/solid-query-persist-client@6.0.0-rc.0** (head, dependency-contract-obligation): solid-checker: no certifiable artifact case; 3 case(s) refused; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/query-persist-client-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/query-persist-client-core" from <package-root>/build/index.js; acquire a verified dependency contract and pass its receipt-issued exact impo... _(stderr truncated for readability)_
- **@tanstack/solid-start-server@2.0.0-rc.2** (floor, dependency-contract-obligation): solid-checker: no certifiable artifact case; 1 case(s) refused and 1 case(s) recorded inapplicable; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/start-server-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/start-server-core" from <package-root>/dist/esm/index.js; acquire a verified dependency contract and pass its re... _(stderr truncated for readability)_
- **@tanstack/solid-start-server@2.0.0-rc.2** (head, dependency-contract-obligation): solid-checker: no certifiable artifact case; 1 case(s) refused and 1 case(s) recorded inapplicable; first refusal: .: solid-checker:unresolved-dependency-module=@tanstack/start-server-core solid-checker-rust: emit package contract: cannot statically expand external export-all "@tanstack/start-server-core" from <package-root>/dist/esm/index.js; acquire a verified dependency contract and pass its re... _(stderr truncated for readability)_
...
- Worker time: 1716469 ms
- Phases: install 105467 ms, generation 632678 ms, harness 978324 ms
