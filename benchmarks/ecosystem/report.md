...
- Started: 2026-08-29T19:02:15.616Z
- Finished: 2026-08-29T19:09:57.009Z
- Duration: 461393 ms
...
- Refused artifact cases (partial contracts): 680
...
- Refused entrypoints (partial contracts): 0
- Refused artifact cases (partial contracts): 137
...
Failure groups:
- 1x export-kind-unresolved: no certifiable artifact case; 48 case(s) refused; first refusal: .: solid-checker-rust: emit package contract: entry file exports "<value>", whose runtime kind no closed type answers (Unknown, Unknown); publishing kind "<value>" would certify it invokes no caller-supplied callback (packages: @kobalte/utils)
...
- 1x unclassified: no certifiable artifact case; 220 case(s) refused; first refusal: ./client: local closure module ./read-preferred-language-cookie.js?raw from <package-root>/dist/client/preferred-language.js was not found (packages: @kobalte/solidbase)

Failure details:
- **@kobalte/solidbase@0.6.13** (only, unclassified): solid-checker: no certifiable artifact case; 220 case(s) refused; first refusal: ./client: local closure module ./read-preferred-language-cookie.js?raw from <package-root>/dist/client/preferred-language.js was not found
...
- **@kobalte/utils@0.9.2** (only, export-kind-unresolved): solid-checker: no certifiable artifact case; 48 case(s) refused; first refusal: .: solid-checker-rust: emit package contract: entry file /private<package-root>/dist/index.js exports "EventKey", whose runtime kind no closed type answers (Unknown, Unknown); publishing kind "value" would certify it invokes no caller-supplied callback
...
Failure groups:
- 1x dependency-contract-obligation: no certifiable artifact case; 18 case(s) refused; first refusal: ./accordion: solid-checker:unresolved-dependency-module=@corvu/accordion solid-checker-rust: emit package contract: cannot statically expand external export-all "<value>" from ; acquire a verified dependency contract and pass its receipt-issued exact import through --accepted-contracts (packages: corvu)

Failure details:
- **corvu@0.7.2** (only, dependency-contract-obligation): solid-checker: no certifiable artifact case; 18 case(s) refused; first refusal: ./accordion: solid-checker:unresolved-dependency-module=@corvu/accordion solid-checker-rust: emit package contract: cannot statically expand external export-all "@corvu/accordion" from /private<package-root>/dist/accordion.js; acquire a verified dependency contract and pass its receipt-issued exact import through --acc... _(stderr truncated for readability)_
...
- Refused entrypoints (partial contracts): 0
- Refused artifact cases (partial contracts): 71
- Success (complete contracts): 3/36 (8.33%)
- Partial contracts: 14
- Failures: 19
...
- 1x package-contract-export-missing: no certifiable artifact case; 24 case(s) refused; first refusal: ./solid: solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>" } solid-checker-rust: normalized operation graph is invalid: inference has no entrypoint "<value>" (packages: @tanstack/charts)
...
- 1x unclassified: no certifiable artifact case; 24 case(s) refused; first refusal: ./solid: solid-checker-rust: normalized operation graph is invalid: inference has no entrypoint "<value>" (packages: @tanstack/devtools-utils)
...
- **@tanstack/charts@0.15.0** (only, package-contract-export-missing): solid-checker: no certifiable artifact case; 24 case(s) refused; first refusal: ./solid: solid-checker:unknown-claim-attribution={"analysisContext":"no receipt-accepted contract matches this exact import","domains":["reactiveReads","returns","callbacks","ownerRequirements","asyncBehavior"],"endByte":407,"exports":["Chart"],"mechanism":"fallback-all","obligation":"PackageContractExportMissing","pat... _(stderr truncated for readability)_
...
- **@tanstack/devtools-utils@0.7.0** (only, unclassified): solid-checker: no certifiable artifact case; 24 case(s) refused; first refusal: ./solid: solid-checker-rust: normalized operation graph is invalid: inference has no entrypoint "./solid"
...
| @solid-devtools/shared | 0.20.0 | only | failure | no-exported-surface |
...
- 1x no-exported-surface: no certifiable artifact case; 14 case(s) refused; first refusal: .: solid-checker-rust: emit package contract: entry file has no runtime ESM exports (packages: @solid-devtools/shared)
...
- **@solid-devtools/shared@0.20.0** (only, no-exported-surface): solid-checker: no certifiable artifact case; 14 case(s) refused; first refusal: .: solid-checker-rust: emit package contract: entry file /private<package-root>/dist/index.js has no runtime ESM exports
...
**Solid 1.x totals:** 22/168 (13.1%) complete, 103 partial, 43 failed
...
- Refused entrypoints (partial contracts): 0
- Refused artifact cases (partial contracts): 614
- Success (complete contracts): 6/15 (40%)
- Partial contracts: 9
- Failures: 0
...
- Generated entrypoints: 1
- Refused entrypoints (partial contracts): 0
- Refused artifact cases (partial contracts): 14
...
| Package | Version | Probe | Outcome | Class |
| --- | --- | --- | --- | --- |
| @kobalte/core | 2.0.0-alpha.0 | only | failure | package-contract-export-missing |
| @kobalte/utils | 2.0.0-alpha.0 | only | partial-success | partial-success |

Failure groups:
- 1x package-contract-export-missing: no certifiable artifact case; 122 case(s) refused; first refusal: ./accordion: solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker:unknown-claim-attribution={ "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>", "<value>"], "<value>", "<value>", "<value>", "<value>" } solid-checker-rust: normalized operation graph is invalid: inference has no entrypoint "<value>" (packages: @kobalte/core)

Failure details:
- **@kobalte/core@2.0.0-alpha.0** (only, package-contract-export-missing): solid-checker: no certifiable artifact case; 122 case(s) refused; first refusal: ./accordion: solid-checker:unknown-claim-attribution={"analysisContext":"no receipt-accepted contract matches this exact import","domains":["reactiveReads","returns","callbacks","ownerRequirements","asyncBehavior"],"endByte":67,"exports":["Accordion","Content","Header","Item","Root","Trigger","useAccordionContext"],"m... _(stderr truncated for readability)_
...
**Solid 2.x totals:** 22/250 (8.8%) complete, 211 partial, 17 failed
...
- Probes with at least one refused entrypoint: 314
- Probes with at least one closure note: 0
- Exports proven: 0/4562 (0%) (with unknown: 4562, without a summary: 0)
- Of those unknown exports: 14 unknown in every measured domain (the generator said nothing about them at all), 0 unknown only inside a conditional variant (the default resolution is fully claimed)
- Entrypoints: 358 emitted, 0 refused; 1954 artifact cases refused
...
| --- | ---: | ---: | ---: | ---: |
| Pretty main | 358 | 2114 | 8928 | 47265 |
| Canonical minified main | 358 | 1626 | 4967 | 31860 |
| Proposal plan (not evidence) | 358 | 49252 | 303349 | 2736092 |
| Canonical bytes per export | 358 | 333.25 | 1081 | 1936 |
| Canonical bytes per operation | 80 | 712.05 | 2138 | 3349 |
...
Read the domain columns together, not separately: 14 of the 4562 unknown exports are unknown in every measured domain at once, so the same export can contribute to several columns.
...
| @solidjs/web@2.0.0-rc.3 | solid2 | 2034 | 226/226 | 0 | 0 | callbacks |
...
| @solidjs/router@2.0.0-next.18 | solid2 | 505 | 56/56 | 1 | 0 | callbacks |
...
- Worker time: 2858567 ms
- Phases: install 48111 ms, generation 2653208 ms, harness 157248 ms
...
- @corvu-next/utils@0.1.5 (corvu): 1 entrypoint(s) generated, 0 entrypoint(s) and 32 artifact case(s) refused
- @corvu/utils@0.4.2 (corvu): 1 entrypoint(s) generated, 0 entrypoint(s) and 32 artifact case(s) refused
- @kobalte/core@0.13.13 (kobalte): 1 entrypoint(s) generated, 0 entrypoint(s) and 137 artifact case(s) refused
- @kobalte/utils@2.0.0-alpha.0 (kobalte): 1 entrypoint(s) generated, 0 entrypoint(s) and 14 artifact case(s) refused
...
- @solidjs/h@2.0.0-rc.3 (official-solid): 1 entrypoint(s) generated, 0 entrypoint(s) and 4 artifact case(s) refused
...
- @solidjs/universal@2.0.0-rc.3 (official-solid): 1 entrypoint(s) generated, 0 entrypoint(s) and 4 artifact case(s) refused
- @solidjs/vite-plugin@3.0.0-next.34 (official-solid): 1 entrypoint(s) generated, 0 entrypoint(s) and 4 artifact case(s) refused
- @solidjs/vite-plugin@3.0.0-next.34 (official-solid): 1 entrypoint(s) generated, 0 entrypoint(s) and 4 artifact case(s) refused
- @solidjs/web@2.0.0-rc.3 (official-solid): 1 entrypoint(s) generated, 0 entrypoint(s) and 418 artifact case(s) refused
- @tanstack/ai-devtools-core@0.5.8 (tanstack): 1 entrypoint(s) generated, 0 entrypoint(s) and 24 artifact case(s) refused
...
- @tanstack/pacer-devtools@1.4.0 (tanstack): 1 entrypoint(s) generated, 0 entrypoint(s) and 12 artifact case(s) refused
...
- solid-js@1.9.14 (official-solid): 1 entrypoint(s) generated, 0 entrypoint(s) and 664 artifact case(s) refused
- solid-js@2.0.0-rc.3 (official-solid): 1 entrypoint(s) generated, 0 entrypoint(s) and 166 artifact case(s) refused
