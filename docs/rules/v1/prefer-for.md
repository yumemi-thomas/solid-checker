...
This preference is enabled by default. Disable it explicitly when raw mapping
better communicates the intended rendering behavior.
...
`"solid-checker/v1/prefer-for": "off"`.
