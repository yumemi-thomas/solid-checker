...
bindings such as event handlers and `ref` are excluded too. Shared with the 1.x
catalog as [v1/uncalled-accessor](v1/uncalled-accessor.md) under the same code,
so a suppression comment survives a migration.
