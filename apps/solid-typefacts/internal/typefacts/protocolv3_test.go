...
func TestHandshakeDeclaresTheOperationSetsProtocol(t *testing.T) {
	if typefacts.TypeFactsHandshakeProtocol != 20 {
		t.Fatalf(
			"handshake protocol = %d, want 20: an implementation transcript may name the declaration whose body it walked (implementationOf)",
