...
| Package contracts | shared contract schema and resolver | review: `contracts/solid-v1/solid-js.json`; bundled: `bundled/solid-v1/solid-js.json`, package `solid-js@1.9.14` | review: `contracts/solid-v2/*`; bundled: `bundled/solid-v2/*`, packages `solid-js` and `@solidjs/web` at `2.0.0-beta.31` |
