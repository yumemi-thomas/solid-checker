...
pub use contract_certification::{
    ...
    ReceiptPublicationError, SnapshotLimits, SnapshotVerifiedClosure, SnapshotVerifiedExports,
    ...
    VerifiedProbeGateBatch, VerifiedTypeFactsEvidence, WitnessWireError,
