...
fn prepare_analyze_response(
    ...
    if response.table_transition.is_empty() {
        ...
        if candidate.schema() != v3::TYPE_FACTS_TABLE_SCHEMA_V7
    ...
    if transition.project_id.as_ref() != response.project_id.as_str()
        ...
        || transition.table_schema != v3::TYPE_FACTS_TABLE_SCHEMA_V7
    {
        return Err(SessionError::InvalidResponse(
...
mod tests {
    ...
    fn delta_transition(
        ...
        WireTableTransition {
            ...
            table_schema: v3::TYPE_FACTS_TABLE_SCHEMA_V7,
            base_generation,
            target_generation,
