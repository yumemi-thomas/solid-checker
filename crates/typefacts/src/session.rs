...
fn prepare_analyze_response(
    ...
    if response.table_transition.is_empty() {
        ...
        if candidate.schema() != v3::TYPE_FACTS_TABLE_SCHEMA_V12
    ...
    if transition.project_id.as_ref() != response.project_id.as_str()
        ...
        || transition.table_schema != v3::TYPE_FACTS_TABLE_SCHEMA_V12
    {
        return Err(SessionError::InvalidResponse(
...
mod tests {
    ...
    fn fact_table(
        ...
        FactTable::from_parts(
            v3::TYPE_FACTS_TABLE_SCHEMA_V12,
            1,
            "/p/tsconfig.json",
            sources,
            entities,
    ...
    fn delta_transition(
        ...
        WireTableTransition {
            ...
            table_schema: v3::TYPE_FACTS_TABLE_SCHEMA_V12,
            base_generation,
            target_generation,
