...
//
// `velocityPerSecond(velocity, frameDuration)` is arithmetic over two numbers
// with a guard for a zero frame.
...
export async function runProbeSession(_session, harness) {
  ...
  expect("velocityPerSecond(10, 100)", velocityPerSecond(10, 100) === 100);
  expect("velocityPerSecond(10, 0) is 0", velocityPerSecond(10, 0) === 0);
