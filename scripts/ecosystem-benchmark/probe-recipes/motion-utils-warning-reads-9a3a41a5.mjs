...
//
// `warning(check, message)` logs when `check` is false and otherwise returns
// `undefined`, in either build of the module. Only the passing branch is
// sampled, so nothing is logged.
...
export async function runProbeSession(_session, harness) {
  ...
  expect("warning(true) returns undefined", warning(true, "probe recipe", "probe") === undefined);
