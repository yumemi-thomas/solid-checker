...
//
// `wrap(min, max, v)` is modular arithmetic over three numbers.
...
export async function runProbeSession(_session, harness) {
  ...
  expect("wrap(0, 10, 12)", wrap(0, 10, 12) === 2);
  expect("wrap(0, 10, -1)", wrap(0, 10, -1) === 9);
  expect("wrap(0, 10, 5)", wrap(0, 10, 5) === 5);
