...
//
// `millisecondsToSeconds(ms)` is one division.
...
export async function runProbeSession(_session, harness) {
  ...
  expect("millisecondsToSeconds(1500)", millisecondsToSeconds(1500) === 1.5);
  expect("millisecondsToSeconds(0)", millisecondsToSeconds(0) === 0);
